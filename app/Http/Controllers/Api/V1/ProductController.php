...
class ProductController extends Controller
{
    ...
    public function bulk_export_data()
    {
        ...
        (new FastExcel($format))->export(storage_path('app/public/report/Export_products.xlsx'));
        $path = asset('storage/app/public/report/Export_products.xlsx');
        return response()->json(['excel_report' => $path]);
    }

    public function downloadExcelSample()
    {
        $path = asset('storage/app/public/product/product_bulk_format.xlsx');
