...
class ExpenseController extends Controller
{
    public function getExpense(Request $request)
    {
        ...
        $expenses = Transection::with('account')->where('tran_type', '=', 'Expense')->latest()->paginate($limit, ['*'], 'page', $offset);
        $data = [
     ...
     */
    public function storeExpenses(Request $request, Transection $expense)
    {
        $request->validate([
            'account_id' => 'required',
    ...
    public function getSearch(Request $request)
    {
        ...
        if (!empty($request->from && $request->to)) {
            $result = Transection::when(($request->from && $request->to), function ($query) use ($request) {
    ...
    public function transferList(Request $request)
    {
        ...
        $transfers = Transection::with('account')->where('tran_type', '=', 'Transfer')->latest()->paginate($limit, ['*'], 'page', $offset);
        $data = [
