...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::group(['middleware' => ['auth:admin-api']], function () {
        ...
        Route::group(['prefix' => 'transaction'], function () {
            ...
            Route::get('transfer/export', [TransactionController::class, 'transferListExport']);
        ...
        Route::group(['prefix' => 'product'], function () {
            ...
            Route::get('export', [ProductController::class, 'bulk_export_data']);
            Route::get('download/excel/sample', [ProductController::class, 'downloadExcelSample']);
            Route::get('barcode/generate', [ProductController::class, 'barcode_generate']);
